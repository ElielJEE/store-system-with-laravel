...
@section('content')
    <div class="categories-container">
        <form action="{{route('products.update', $product)}}" class="categorie-form" method="POST">
            ...
            <input type="text" class="input input-category" name="name" placeholder="Ingresar nombre de producto" value="{{$product->nombre_producto}}">
            
            <label for="price" class="category-label label">Precio Producto*</label>
            <input type="number" class="input input-category" name="price" placeholder="Ingresar precio de producto" value="{{$product->precio_producto}}">
