                        ...
                        <ul class="sidebar-list">
                            <li class="sidebar-list__item">
                                <a href="/" class="list-item">
                                    <svg class="svg-icon home-icon" xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 576 512">
                            ...
                            <li class="sidebar-list__item">
                                <a href="/bill" class="list-item">
                                    <svg class="svg-icon bill-icon" xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 512 512">
                                        <!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                                        <path
                            ...
                            <li class="sidebar-list__item">
                                <a href="/products" class="list-item">
                                    <svg class="svg-icon products-icon" xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 640 512">
                                        <!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                                        <path
                            ...
                            <li class="sidebar-list__item">
                                <a href="/categorie" class="list-item">
                                    <svg class="svg-icon category-icon" xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 576 512">
                                        <!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                                        <path
                            ...
                            <li class="sidebar-list__item">
                                <a href="/customer" class="list-item">
                                    <svg class="svg-icon customers-icon" xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 640 512">
                                        <!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                                        <path
